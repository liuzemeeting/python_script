...
from apps.statist.common.task_common import stu_task_data_handle, day_range, month_range
from apps.utils.res import json_response


class TaskStuAPI(Resource):
    ...
    def get():
        ...
        data_sql = """
                            SELECT
                                ...
                                SUM(tongbuchuanguan) as tongbuchuangguan
                            FROM
                                tbkt_statistics.statist_stu_test
                            WHERE 
        ...
        d = stu_task_data_handle(data, x_asix)
